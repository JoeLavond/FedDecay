...
Several other works~\citep{fl-noniid, scaffold, fed-opt} propose to improve the original FedAvg procedure. 
However, many of these works improve the global optimization step. 
Unlike our work, they do not consider the local learning rate, especially within the communication round. 
