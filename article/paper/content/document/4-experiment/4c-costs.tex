...
The cost of learning rate scheduling is negligible per iteration.
Importantly, within-round decay does not alter the number of communication rounds: the global aggregation step is unchanged, and the convergence rate of $\mathcal{O}(N^{-1})$ established in Theorem~\ref{thm: conv} matches that of FedAvg.
This is confirmed empirically: FedDecay terminates in the same number of epochs as FedAvg on FEMNIST and SST2.
